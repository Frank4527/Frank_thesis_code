...
pair  w_stage1__val_rerun        "$WBANK" none "1.0" "1.0" validation "$R1/w_stage1__both__val_rerun.json"        "$N_OLD_VAL"
...
for TAG in rehearsal001 rehearsal005; do   # joint reused from b2q
...
pair  w_stage1__test_rerun       "$WBANK" none  "1.0" "1.0" test "$R1/w_stage1__both__test_rerun.json"          "$N_OLD_TEST"
